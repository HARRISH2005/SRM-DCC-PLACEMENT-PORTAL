    ...
    extend: {
      ...
      colors: {
        ...
        badge: {
          ...
          "super-dream": "hsl(var(--badge-super-dream))",
          dream: "hsl(var(--badge-dream))",
          core: "hsl(var(--badge-core))",
          it: "hsl(var(--badge-it))",
          startup: "hsl(var(--badge-startup))",
        },
        chart: {
          line: "hsl(var(--chart-line))",
          area: "hsl(var(--chart-area))",
        },
        compensation: "hsl(var(--compensation))",
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      boxShadow: {
        ...
        float: "0 8px 30px -6px rgb(0 0 0 / 0.10), 0 3px 10px -3px rgb(0 0 0 / 0.05)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
